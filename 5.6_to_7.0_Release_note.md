...
| ------ | ------ | ------ |
| nullable | 7.1.0 | VD: ?string thì có thể trả về string hoặc null |
| void | 7.1.0 | Thêm kiểu trả về void |
| iterable | 7.1.0 | Thêm kiểu trả về iterable: function gen(): iterable { yield 1; } |
| object | 7.2.0 | Thêm kiểu trả về object |
...
| void | 8.1.0 | Kiểu trả về void sẽ bị đánh dấu là không được sử dụng nữa deprecated |
